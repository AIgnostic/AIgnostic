expected_ACS_column_names = [
    "RT", "SERIALNO", "DIVISION", "SPORDER", "PUMA", "REGION", "ST",
    "ADJINC", "PWGTP", "AGEP", "CIT", "CITWP", "COW", "DDRS", "DEAR",
    "DEYE", "DOUT", "DPHY", "DRAT", "DRATX", "DREM", "ENG", "FER",
    "GCL", "GCM", "GCR", "HIMRKS", "HINS1", "HINS2", "HINS3",
    "HINS4", "HINS5", "HINS6", "HINS7", "INTP", "JWMNP", "JWRIP",
    "JWTRNS", "LANX", "MAR", "MARHD", "MARHM", "MARHT", "MARHW",
    "MARHYP", "MIG", "MIL", "MLPA", "MLPB", "MLPCD", "MLPE", "MLPFG",
    "MLPH", "MLPI", "MLPJ", "MLPK", "NWAB", "NWAV", "NWLA", "NWLK",
    "NWRE", "OIP", "PAP", "RELSHIPP", "RETP", "SCH", "SCHG", "SCHL",
    "SEMP", "SEX", "SSIP", "SSP", "WAGP", "WKHP", "WKL", "WKWN",
    ...
    "FGCMP", "FGCRP", "FHICOVP", "FHIMRKSP", "FHINS1P", "FHINS2P",
    "FHINS3C", "FHINS3P", "FHINS4C", "FHINS4P", "FHINS5C", "FHINS5P",
    "FHINS6P", "FHINS7P", "FHISP", "FINDP", "FINTP", "FJWDP", "FJWMNP",
    "FJWRIP", "FJWTRNSP", "FLANP", "FLANXP", "FMARP", "FMARHDP", "FMARHMP",
    "FMARHTP", "FMARHWP", "FMARHYP", "FMIGP", "FMIGSP", "FMILPP", "FMILSP",
    "FOCCP", "FOIP", "FPAP", "FPERNP", "FPINCP", "FPOBP", "FPOWSP",
    "FPRIVCOVP", "FPUBCOVP", "FRACP", "FRELSHIPP", "FRETP", "FSCHGP",
    "FSCHLP", "FSCHP", "FSEMP", "FSEXP", "FSSIP", "FSSP", "FWAGP", "FWKHP",
    "FWKLP", "FWKWNP", "FWRKP", "FYOEP", "PWGTP1", "PWGTP2", "PWGTP3",
    "PWGTP4", "PWGTP5", "PWGTP6", "PWGTP7", "PWGTP8", "PWGTP9", "PWGTP10",
